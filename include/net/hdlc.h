...
/**
 * Write a buffer to the specified HDLC address
 * 
 * This function prepends and appends the @ref HDLC_FLAG character on
 * the outgoing message, escapes HDLC_FLAG and @ref HDLC_ESC
 * characters if found after the initial HDLC_FLAG, and also calculates
 * and appends the Frame Check Sequence (FCS). 
 *
 * @param hdlc_context the HDLC context to use
